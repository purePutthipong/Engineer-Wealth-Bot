...
# สูตรคำนยณ RSI แบบ Wilder's Smoothing (มาตรฐานเดียวกับ pandas-ta)
...
print(f"🔄 System Running... Manual Math Mode")
...
for ticker in ['QQQM', 'SMH']:
    try:
        ...
        # คำนวณ RSI และ SMA120 ด้วย pandas พื้นฐาน
...
alert = "\n\n⚠️ **CRITICAL ALERT** ⚠️\nBuffer Low (<$100). **STOP TRADING. REFILL CASH.**" if PORTFOLIO_HOLDINGS['CASH'] < 100 else ""
